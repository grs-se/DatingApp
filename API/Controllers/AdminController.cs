...
namespace API.Controllers
{
    public class AdminController : BaseApiController
    {
        ...
        [Authorize(Policy = "RequireAdminRole")]
        // Technically should be HttpPut but we want to return updated list of roles from this method as well.
        ...
        public async Task<ActionResult> EditRoles(string username, [FromQuery] string roles)
        {
            ...
            // getting name from route parameter, so need to check if isNull, not getting it from Token this time.
